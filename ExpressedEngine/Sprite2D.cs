...
namespace ExpressedEngine.ExpressedEngine
{
    public class Sprite2D
    {
        ...
        public Sprite2D(Vector2 Position, Vector2 Scale, string Directory, string Tag)
        {
            ...
            //Bitmap sprite =  new Bitmap(tmp,(int)this.Scale.X, (int)this.Scale.Y); // with scaling
        ...
        public void AddImpulse(Vector2 force,Vector2 point)
        {
        ...
        public void UpdatePosition()
        {
            ...
            //Log.Warning(bodyDef.Position.X + " | " + bodyDef.Position.Y); 
